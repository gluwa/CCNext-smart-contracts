...
// contracts/common/BlockProverTypes.sol. Copied here so this example is self-contained;
// the canonical source is the USC core repository. Pragma relaxed to ^0.8.20 to match the
// example's compiler; no code changes otherwise.
